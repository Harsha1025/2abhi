 document.addEventListener('DOMContentLoaded', function () {
    ...
    // New function to fetch products from backend API and render
    function fetchProductsFromAPI() {
        fetch('http://localhost:5000/api/products')
            ...
            .catch(error => {
                ...
                // Fallback to render static products if API fails
                renderProducts();
            });
    }

    // Replace initial renderProducts call with fetchProductsFromAPI
